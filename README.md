Simulation of a robotic tricycle platform taking into account friction forces. After launching program you have to press one of the transmission button. Otherwise robot won't move at all
# Controls:
## Movement
